          ...
          {currentUser?.role === 'ROLE_CHEF' && (
            <>
              ...
              >
                ...
                <span>Chef Kitchen Display</span>
              </button>
          ...
          {(currentUser?.role === 'ROLE_MANAGER' || currentUser?.role === 'ROLE_ADMIN') && (
            <>
              ...
              >
                ...
                <span>Chef Station Overview</span>
              </button>
            ...
            <div className="hidden sm:flex flex-col items-start text-left">
              ...
              {currentUser && (
                <span className="text-[9px] font-bold text-amber-400 font-mono">
                  {currentUser.role === 'ROLE_CHEF' ? '👨‍🍳 Chef' : currentUser.role === 'ROLE_MANAGER' || currentUser.role === 'ROLE_ADMIN' ? '👔 Manager' : '🍽️ Customer'}
                </span>
              )}
            </div>
            {currentUser && (
